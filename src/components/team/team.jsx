...
function Team() {
    ...
    return (
        ...
        <div className="body-team">
            ...
            <div className="tittle-team">
                <Heading className="title-team-text">Team</Heading>
                <Text className="text-title-team">
            ...
            <div className="container-flex-team">

                <div className="container-img-team">

                    <Card
                        className="img-container-team"
                    >
                        <Image
                            className="img-team"
                            objectFit='cover'
                ...
                <div className="container-text-team">
                    ...
                    <Card
                        className="span-container-team"
                    >

                        <Text className="text-container-team">
            ...
            <div className="responsive-team">

                <br></br>
                <br></br>

                <div className="container-text-team-2">

                    <Text className="text-container-team-2">
                        ● Our team is made up of professionals in different areas, such as SEO, social networks,
                        online advertising, design, content marketing and more. Each one of them contributes their
                        experience and knowledge to ensure that our clients receive a high quality and personalized
                        digital marketing service
                ...
                <div className="container-img-team-2">

                    <Card
                        className="img-container-team-2"
                    >
                        <Image
                            className="img-team-2"
                            objectFit='cover'
                            src='https://paypertalent.com/images/digital-marketing-team.jpg'
                            alt='Caffe Latte'
                        />
